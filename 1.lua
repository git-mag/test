...
-- Function to teleport to all players once
local function teleportToAllPlayers()
    local function teleport(player)
        ...
        if character and getRoot(character) then
            ...
            if playerCharacter and getRoot(playerCharacter) then
                getRoot(playerCharacter).CFrame = CFrame.new(targetPosition + Vector3.new(0, 5, 0))
                wait(2)  -- Adjust delay as needed between teleports
            end
        end
    end
...
-- Function to toggle fling, noclip, and teleport to all players once
local function toggleFlingAll()
    toggleNoclip()  -- Enable noclip
    toggleFling()   -- Start fling
    teleportToAllPlayers()  -- Teleport to all players once
end
